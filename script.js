$(document).ready(function(){
   function makeCard(title, description, image, link1, link2, bgcolor) {
      ...
      '<p>' + description + '</p><button><a class="button" href="' + link1 + '">Repo</a></button><a class="button" href="' + link2 + '"><button>Site</a></button>');
  ...
  makeCard("Scheduler", 
    ...
    'pics/scheduler.png', "https://github.com/erin-smith/schedule-planner", "https://erin-smith.github.io/schedule-planner", "lightblue");
  ...
  'pics/passwordgen.png', 'https://github.com/erin-smith/password-gen-homework', "https://erin-smith.github.io/password-gen-homework/", "lightgrey");
  ...
  "Resume, Bio, Contacts", 
  'pics/myfirstpage.png', "https://github.com/erin-smith/student-bio", "https://erin-smith.github.io/student-bio/", "#efeee7");
